...
if($name && $email && $phone && $message){
 ...
 if(mail("kamil.chajdys@gmail.com","Formularz kontaktowy",$message_body,$headers)){
 $json=array("status"=>1,"msg"=>"<p class='status_ok'>Twoja wiadomość została pomyślnie wysłany. <br/> Odpowiem najszybciej jak to będzie możliwe.</p>");
 }
 else{
